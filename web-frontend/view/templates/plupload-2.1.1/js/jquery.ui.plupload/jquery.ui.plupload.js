				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							...
							'<a class="plupload_button plupload_clean">' + _('Clean Upload') + '</a>&nbsp;' +
...
$.widget("ui.plupload", {
	...
	_create: function() {
		...
		this.clean_button = $('.plupload_clean', this.container).attr('id', id + '_clean'); // by diwen
	...
	_initUploader: function() {
		...
		uploader.bind('PostInit', function(up) {
			...
			self.clean_button.button('enable').show();  // diwen
			...
			self.clean_button.click(function(e) {
				self._clean();
				e.preventDefault();
			});
	...
	_setOption: function(key, value) {
		...
		if (key == 'buttons' && typeof(value) == 'object') {
			...
			self.clean_button.button('enable').show();
